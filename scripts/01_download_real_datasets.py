...
def main():
    ...
    print("=" * 50)
    print(f"Registered real datasets:       {len(all_specs)}")
    ...
    print("")
    print(f"Controlled real available:      {controlled_avail} / {len(list_controlled_real())}")
    print(f"Natural-shift available:        {natural_avail} / {len(list_natural_shift())}")
    print("=" * 50)
