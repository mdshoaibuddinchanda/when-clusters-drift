...
def main():
    ...
    print("=" * 60)
    print(f"Registered Real Datasets:        {len(all_real_specs)}")
    print(f"  - Controlled Real Available:   {len(controlled_avail)} / {len(list_controlled_real())}")
    print(f"  - Natural Datasets Available:  {len(natural_dataset_ids)} / {len(natural_specs)}")
